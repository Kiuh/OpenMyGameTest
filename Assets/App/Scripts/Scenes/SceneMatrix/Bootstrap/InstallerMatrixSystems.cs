...
namespace App.Scripts.Scenes.SceneMatrix.Bootstrap
{
    ...
    {
        [SerializeField]
        private ViewSwitchNavigator levelSwitcher;

        [SerializeField]
        private ViewSwitchNavigator figureRotator;
        ...
        protected override void OnInstallBindings()
        {
            ...
            _ = systemGroup.AddSystem(
                Container.CreateInstanceWithArguments<SystemRotateFigure>(figureRotator)
            );
            _ = systemGroup.AddSystem(Container.CreateInstance<SystemRebuildField>());
            _ = systemGroup.AddSystem(
                Container.CreateInstanceWithArguments<SystemSwitchFigure>(levelSwitcher)
            );
